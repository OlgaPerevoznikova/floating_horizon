...
struct TGA_Header
{
	...
	uint8_t img_desc;//описание изображения
};
#pragma pack(pop)
...
constexpr double rx = 20., ry = 20., rz = 300., xmax = 30., xmin = -30., ymax = 30., ymin = -30., step1 = 0.5, step2 = 0.01;
...
int main()
{
	std::vector<uint32_t> picture(W * H);//построить график
	...
	TGA_Header hdr {};//записать построенное изображение в файл формата TGA
	hdr.width = W;
	hdr.height = H;
	hdr.depth = 32;
	hdr.img_type = 2;
